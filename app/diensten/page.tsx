...
const MainServices = () => {
  const services = [
    ...
    },
    {
      ...
      description: "Onze autotransport service is speciaal ontwikkeld voor het veilig vervoeren van voertuigen tot 3,5 ton. Geschikt voor dealers, lease-maatschappijen en particulieren.",
      features: [
